...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        page = LoginPage(browser, url="http://selenium1py.pythonanywhere.com/en-gb/accounts/login/")
        page.open()
    ...
    def test_user_can_add_product_to_basket(self, browser, url="http://selenium1py.pythonanywhere.com/en-gb/catalogue"
